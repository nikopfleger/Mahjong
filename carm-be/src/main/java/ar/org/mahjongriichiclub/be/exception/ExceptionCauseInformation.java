...
public class ExceptionCauseInformation implements Serializable {
	...
	/**
	 * Construct a new ExceptionCauseInformation using the exception class and localizedMessage for
	 * its exceptionClass and exceptionMessage.
	 * @param e the exception to take information from.
	 */
	public ExceptionCauseInformation(Exception e){
		this(e.getClass().getName(), (e.getLocalizedMessage() == null || e.getLocalizedMessage().length() == 0) ? "" : e.getLocalizedMessage());
	}
